    ...
    void save(ActionEvent event) {
         try{
             ...
             if(c_name.getText()!=null && c_add.getText()!=null && created_by.getText()!=null){
                 if(created_by.getText().toLowerCase().equals("admin")){
                     status = "approved";
                 }
                pst = connection.prepareStatement("insert into company values('0','"+c_name.getText()+"','"+c_add.getText()+"','"+created_by.getText()+"','"+status+"')");
                pst.execute();
                reset(event);
