...
public class EditController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        // TODO
        fadeIn();
        c_name.setText(coy_name);
        c_add.setText(coy_add);
    ...
    void save(ActionEvent event) {
         try{
             if(c_name.getText()!=null && c_add.getText()!=null){
                pst = connection.prepareStatement("update company set company_name = '"+c_name.getText()+"',company_address = '"+c_add.getText()+"' where company_name = '"+coy_name+"'");
                pst.execute();
                reset(event);
