 ...
 * @author akash
 */
public class Cal extends javax.swing.JDialog {
int lastX, lastY;
int count = 0;
wall w;
    /**
     ...
     */
    public Cal(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        getContentPane().add(c3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 150, 30, 40));
        ...
        getContentPane().add(c7, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 210, 40, 40));
        ...
        getContentPane().add(c18, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 400, 30, 30));
        ...
        getContentPane().add(c17, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 400, 40, 30));
        ...
        getContentPane().add(c1, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 150, 30, 40));

        tf1.setFont(new java.awt.Font("Arabic Typesetting", 2, 30)); // NOI18N
        tf1.setHorizontalAlignment(javax.swing.JTextField.TRAILING);
        tf1.setAutoscrolls(false);
        tf1.setBorder(null);
        ...
        getContentPane().add(tf1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 40, 230, 40));
        ...
        getContentPane().add(c16, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 400, 40, 30));
        ...
        getContentPane().add(c11, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 270, 40, 40));
        ...
        getContentPane().add(c6, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 210, 30, 40));

        jLabel3.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 130, 20, 20));

        jLabel2.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 130, 20, 20));
        ...
        getContentPane().add(c19, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 400, 30, 30));
        ...
        getContentPane().add(c4, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 210, 30, 40));
        ...
        getContentPane().add(c15, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 340, 30, 30));
        ...
        getContentPane().add(c, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 150, 40, 40));
        ...
        getContentPane().add(c10, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 270, 40, 40));
        ...
        getContentPane().add(c2, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 150, 30, 40));
        ...
        getContentPane().add(c13, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 340, 40, 30));
        ...
        getContentPane().add(c12, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 340, 40, 30));
        ...
        getContentPane().add(c8, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 270, 30, 40));
        ...
        getContentPane().add(c9, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 280, 30, 30));
        ...
        getContentPane().add(c5, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 210, 30, 40));
        ...
        getContentPane().add(c14, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 340, 30, 30));

        tf2.setEditable(false);
        tf2.setFont(new java.awt.Font("Arabic Typesetting", 2, 30)); // NOI18N
        tf2.setHorizontalAlignment(javax.swing.JTextField.TRAILING);
        tf2.setBorder(null);
        tf2.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        tf2.setOpaque(false);
        tf2.setSelectedTextColor(new java.awt.Color(0, 0, 0));
        tf2.setSelectionColor(new java.awt.Color(255, 153, 51));
        tf2.addMouseMotionListener(new java.awt.event.MouseMotionAdapter() {
            public void mouseMoved(java.awt.event.MouseEvent evt) {
                tf2MouseMoved(evt);
            }
        });
        getContentPane().add(tf2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 80, 230, 40));
        ...
        getContentPane().add(exit, new org.netbeans.lib.awtextra.AbsoluteConstraints(229, 0, -1, 30));
        ...
        getContentPane().add(next, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 140, 50, 10));
        ...
        img.setIcon(new javax.swing.ImageIcon(getClass().getResource("/calculator/calculator1.png"))); // NOI18N
        ...
        getContentPane().add(img, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, 480));
